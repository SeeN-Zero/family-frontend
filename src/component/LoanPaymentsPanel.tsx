        ...
        <div className="flex flex-col gap-4 mb-6">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            <button
              type="button"
              onClick={onClose}
              className="border border-outline-variant px-3 py-2 text-on-surface-variant hover:border-primary hover:text-primary transition-colors cursor-pointer"
          ...
          <table className="w-full min-w-[720px] text-left border-collapse">
            <thead>
              <tr className="border-b border-dotted border-outline-variant">
                ...
                <th className="py-3 px-4 font-label-caps text-label-caps text-on-surface-variant text-center w-24">
                  ACT
                </th>
              </tr>
            </thead>
              ...
              {!isLoading &&
                ...
                payments.map((payment) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-4">{payment.accountName}</td>
